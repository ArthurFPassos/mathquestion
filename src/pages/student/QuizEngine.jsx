...
export default function QuizEngine() {
  ...
  // Busca primeiro nos módulos padrão (UNITS)
  // Se não encontrar, verifica se é um módulo extra de professor
  const moduleFromUnits = UNITS.flatMap((u) => u.modules).find(
  ...
  const unit = UNITS.find((u) =>
    ...
    // Unidade virtual para módulos do professor
    id:    "extra",
    title: "Módulo Extra",
    emoji: "🎓",
    color: "#6366f1",
